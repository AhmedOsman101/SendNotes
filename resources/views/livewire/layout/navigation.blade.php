...
new class extends Component {
    public bool $notesIsActive;

    public function mount()
    {
        $this->notesIsActive = strpos(url()->current(), 'notes') !== false;
    }
...
<nav class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800" x-data="{ open: false }">
            ...
            <div class="flex">
                ...
                <div class="flex shrink-0 items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        ...
                        @php
                            $notesIsActive = strpos(url()->current(), 'notes');
                        @endphp
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :active="$notesIsActive" :href="route('notes.index')" wire:navigate>
                        {{ __('Notes') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="space-y-1 pb-3 pt-2">
            ...
            <x-responsive-nav-link :active="$notesIsActive" :href="route('notes.index')" wire:navigate>
